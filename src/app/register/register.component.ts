...
registerUser()
{
  ...
  if((this.userDetails.username!='' && this.userDetails.email!='' && this.userDetails.password!='') && (this.userDetails.username!=null&& this.userDetails.email!='' && this.userDetails.password!=null))
  {
